...
def build_rocketsim_env():
    ...
    from util.rewards import SpeedTowardBallReward, InAirReward, StrongTouchReward, AirTouchReward, SaveBoostReward
    ...
    reward_fn = CombinedReward.from_zipped(
	    (EventReward(team_goal=4, concede=-4, shot=2, save=2), 5), # Reward for getting goals and touching the ball
        (VelocityBallToGoalReward(), 10), # Move the ball towards the goal
        ...
        (SaveBoostReward(), 1) # Reward saving boost to prevent using it all for immediate speed gain
    )
...
if __name__ == "__main__":
    ...
    wandb_run_name = "ducky-middle-stage-v1-run"
